...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 26 12:05:33 2017
...
def detect(img, scale):
    ...
    #img = img.astype(np.float32)/255 #I might not need this since 
    #I multiplied while training
...
if __name__ == "__main__":
    ...
    clip = VideoFileClip("../../CarND-Vehicle-Detection/project_video.mp4")#.subclip(40,43)
